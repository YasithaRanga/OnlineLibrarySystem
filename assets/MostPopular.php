...
<div class="slide-container">
		...
		<div class="image-slider">
			...
			$query = "SELECT * FROM mostpopular WHERE slotID=1";
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=2";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=3";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=4";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=5";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=6";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
			...
			<?php
			require 'Database/dbconfig.php';
			$query = "SELECT * FROM mostpopular WHERE slotID=7";
			$query_run = mysqli_query($connection,$query);
			$check_abditoryPicks = mysqli_num_rows($query_run)>0;
			$row = mysqli_fetch_assoc($query_run);
			if($check_abditoryPicks)
